...
function RegisterCollege() {
  return (
    ...
    <div className="p-25 text-gray-700 font-serif">
      ...
      <h1 className="text-4xl font-bold mb-45">Welcome To College Portal</h1>
        
        <Card className="w-[40vw] h-[50vh]">
          ...
          <div className="w-45 ml-6 mt-8 ">
            ...
            <h6 className="font-serif mt-4">Please Enter valid data to register a college</h6>
          </div>
        </Card>
      </div>
    </div>
